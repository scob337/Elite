...
// Change Language
function navigateToLink(lang) {
	if (lang === "ar") {
		window.location.replace("../../../AR/الرئيسية.html");
	}
	if (lang === "en") {
...
//   e.preventDefault();
//   alert("تم تعطيل النقر بزر الفأرة الأيمن.");
// });
...
//   if (e.ctrlKey && (e.key === 'i' || e.key === 'I' || e.key === 'j' || e.key === 'J')) {
//     e.preventDefault();
//     alert("تم تعطيل اختصار أدوات المطور.");
//   }
...
//     e.preventDefault();
//     alert("تم تعطيل اختصار عرض المصدر.");
//   }
// });
